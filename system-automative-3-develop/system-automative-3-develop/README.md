...
- `src/OS_Scripts/RHEL-family/Rocky9.sh`
- `src/OS_Scripts/RHEL-family/Rocky10.sh`
- `src/OS_Scripts/Debian-family/Ubuntu24.sh`
...
- 조치:
```bash
nuclei -validate -t ~/nuclei-templates -target 127.0.0.1
```
